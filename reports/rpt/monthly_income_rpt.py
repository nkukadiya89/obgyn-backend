...
def monthly_income_rpt(request, language_id=None, start_date=None, end_date=None):
    ...
    patient_billing_list = PatientBillingModel.objects.filter(
        invoice_date__gte=start_date, invoice_date__lte=end_date, deleted=0
    )
    ...
    for patient_billing in patient_billing_list:
        ...
        if patient_opd:
            ...
            context["col1_total"] = (
                context["col1_total"] + patient_billing.consulting_fees
            )
            ...
            context["col4_total"] = (
                context["col4_total"] + patient_billing.procedure_charge
            )
