...
def create(request):
    ...
    if request.method == "POST":
        ...
        if (patient_opd.patient.age == 0 or patient_opd.patient.age == None or patient_opd.patient.age == "-" or patient_opd.patient.grand_father_name == None or patient_opd.patient.grand_father_name == ""):
            data["success"] = False
