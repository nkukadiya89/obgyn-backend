...
def delete(request):
    ...
    try:
        patient_usgform = PatientUSGFormModel.objects.filter(
            patient_usgform_id__in=del_id["id"]
        )
...
def patch(request, id):
    ...
    if request.method == "POST":
        serializer = PatientUSGFormSerializers(
            patient_usgform, request.data, partial=True
        )
...
def get(request, id=None):
    ...
    try:
        ...
        patient_usgform, data = filtering_query(
            patient_usgform, query_string, "patient_usgform_id", "PATIENTUSGFORM"
        )
...
def delete(request):
    ...
    try:
        usgform_child = USGFormChildModel.objects.filter(
            usgform_child_id__in=del_id["id"]
        )
...
def child_get(request, id=None):
    ...
    try:
        ...
        usgform_child, data = filtering_query(
            usgform_child, query_string, "usgform_child_id", "USGFORMCHILD"
        )
