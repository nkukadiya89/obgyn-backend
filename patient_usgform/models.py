...
class PatientUSGFormModel(models.Model):
    ...
    ref_by_dr = models.CharField(max_length=150,null=True)
    ...
    name_of_doctor = models.ForeignKey(User, on_delete=models.DO_NOTHING, null=True, related_name="name_of_doctor")
