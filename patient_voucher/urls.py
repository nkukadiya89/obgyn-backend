...
from .views import PatientVoucherAPI, patch, get, create, delete, VoucherItemAPI, voucher_item_patch, voucher_item_get
...
urlpatterns = [
    ...
    path('item/create/', create),
    path('item/delete/', delete),
