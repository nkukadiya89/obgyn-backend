...
class ObgynConfigModel(models.Model):
    ...
    city_id = models.ForeignKey(CityModel, on_delete=models.CASCADE, null=True)
    taluka_id = models.ForeignKey(TalukaModel, on_delete=models.CASCADE, null=True)
    district_id = models.ForeignKey(DistrictModel, on_delete=models.CASCADE, null=True)
